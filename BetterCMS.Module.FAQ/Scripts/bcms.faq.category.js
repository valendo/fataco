...
bettercms.define('bcms.faq.category', ['bcms.jquery', 'bcms', 'bcms.modal', 'bcms.siteSettings', 'bcms.dynamicContent', 'bcms.role', 'bcms.media', 'bcms.messages', 'bcms.grid', 'bcms.ko.extenders', 'bcms.redirect', 'bcms.faq'],
    function ($, bcms, modal, siteSettings, dynamicContent, role, media, messages, grid, ko, redirect, faq) {
        'use strict';
        ...
        */
        category.loadSiteSettingsFaqModule = function () {
            var tabs = [],
                ...
                faqs = new siteSettings.TabViewModel("FAQs", faq.links.loadSiteSettingsFaqUrl, faq.initializeFaqList, onShow);
        ...
        */
        category.init = function () {
            bcms.logger.debug('Initializing bcms.faq.category module.');
        };
