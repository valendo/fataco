...
{
    public class GetProductByShortIDCommand : CommandBase, ICommand<string, ProductViewModel>
    {
        private readonly IMediaFileUrlResolver fileUrlResolver;
        public GetProductByShortIDCommand(IMediaFileUrlResolver fileUrlResolver)
        {
            this.fileUrlResolver = fileUrlResolver;
        }

        public ProductViewModel Execute(string shortID)
        {
            var query = Repository
                .AsQueryable<Models.Product>()
                .Where(t => t.Id.ToString().Contains(shortID))
